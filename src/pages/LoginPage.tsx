  ...
  const handleGoogleLogin = useGoogleLogin({
    onSuccess: async (tokenResponse) => {
      ...
      try {
        ...
        setError(err?.response?.data?.message ?? err?.response?.data?.detail ?? 'Error al autenticar con el servidor.')
      } finally {
        setIsLoading(false)
      }
    },
    onError: (error) => {
      ...
      setError('Fallo en el inicio de sesión con Google. Revisa la consola para más detalles.')
      setIsLoading(false)
    }
  })
